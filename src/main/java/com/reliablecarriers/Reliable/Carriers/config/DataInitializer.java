...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            ...
            // Create admin user: reliablecarriersadmn@gmail.com
            if (!userRepository.findByEmail("reliablecarriersadmn@gmail.com").isPresent()) {
                ...
                adminUser.setEmail("reliablecarriersadmn@gmail.com");
            ...
            e.printStackTrace();
            // Don't throw - allow application to continue even if data initialization fails
        }
    }
}
